...
def generate_launch_description():
    ...
    sensor_bridge = Node(
        ...
        arguments=['/quadrotor/IMU@sensor_msgs/msg/Imu@gz.msgs.IMU',
                   ...
                   '/quadrotor/ground_truth@nav_msgs/msg/Odometry@gz.msgs.Odometry'],
        output='screen'
    )
    ...
    nanovoxmap_node = Node(
        ...
        output='screen',
        parameters=[os.path.join(get_package_share_directory('nanovoxmap_ros'), 
                    'config', 
                    'mapping.yaml')]
    )    


    corridor_planning_node = Node(
        package='corridor_planning',
        executable='corridor_planning_node',
        name='corridor_planning_node',
        output='screen',
        parameters=[os.path.join(get_package_share_directory('corridor_planning'),
                    'config',
    ...
    return LaunchDescription([
        ...
        TimerAction(period=5.1, actions=[corridor_planning_node]),
        TimerAction(period=5.2, actions=[traj_opt_node]),
    ])
